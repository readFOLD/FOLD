...
horizontalSections = [
  {
    data: [
      ...
      {
        content: "How did Crimea become part of Ukraine? In 1991, Crimea became part of Ukraine when the Soviet Union (USSR) dissolved into separate states. About 60% of Crimeans are ethnic Russians, and this is used as justification for their return to Russia."
      },
      {
  ...
  },
  {
    ...
    data: [
      {
        content: "What are sanctions? Sanctions include travel bans and asset freezing. For example, none of the sanctioned individuals will be allowed to do business with individuals in the United States. They will not be able to make transactions in dollars, or travel to the United States."
      },
      {
        content: "As of May 2013, the United States has sanctions against: Burma, Cuba, Iran, Libya, North Korea, Sudan, and Syria, as well as many individuals from various other countries."
      }
    ]
  }
]
