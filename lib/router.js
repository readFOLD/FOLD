...
FlowRouter.route("/watch", {
  ...
  action: function() {
    ...
    setMetaDescription();
    setStatusCode();
    FlowLayout.render("watch")
  },
  subscriptions: function() {
    this.register('currentDeepstream', Meteor.subscribe('allDeepstreams'));
  },
  triggersEnter: [function(){
    $('html, body').scrollTop(0);
  }]
...
FlowRouter.route("/curate", {
  ...
  action: function() {
    ...
    setMetaDescription();
    setStatusCode();
    FlowLayout.render("watch", {onCuratePage: true})
  },
  subscriptions: function() {
    this.register('currentDeepstream', Meteor.subscribe('allDeepstreams'));
  },
