...
FlowRouter.route("/", {
  ...
  subscriptions: function() {
    this.register('curatedDeepstreams', longTermSubs.subscribe('allDeepstreams'));
  },
...
FlowRouter.route("/watch/:userPathSegment/:streamPathSegment", {
  ...
  action: function(params) {
    ...
    setMetaDescription();
    setStatusCode();
    FlowLayout.render("watch", {userPathSegment: params.userPathSegment , streamPathSegment: params.streamPathSegment})
  },
...
FlowRouter.route("/curate/:userPathSegment/:streamPathSegment", {
  ...
  action: function(params) {
    ...
    setMetaDescription();
    setStatusCode();
    FlowLayout.render("curate", {onCuratePage: true, userPathSegment: params.userPathSegment , streamPathSegment: params.streamPathSegment})
  },
  subscriptions: function(params) {
    var shortId = idFromPathSegment(params.streamPathSegment);
    this.register('currentDeepstream', Meteor.subscribe('singleDeepstream', params.userPathSegment, shortId));
